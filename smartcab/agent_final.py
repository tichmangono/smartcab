...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        maxQ_action = max({action: reward for action, reward in self.Q[state].items()})
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if self.epsilon > 0.01 and self.epsilon > random.random():
                ...
                same_reward_actions = [action for action in self.Q[state] if self.Q[state][action]==maxQ_action]
